...
@NamedQueries({
    ...
    @NamedQuery(name = "HargaJualBarang.findByNamaBarang", query = "SELECT h FROM HargaJualBarang h WHERE h.namaBarang = :namaBarang"),
...
public class HargaJualBarang implements Serializable {
    ...
    public HargaJualBarang(String idBarang, String namaBarang, BigDecimal hargaJual, String rakBarang) {
        this.idBarang = idBarang;
